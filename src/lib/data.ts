...
export const experiencesData = [
  ...
  },
  {
    ...
    location: "Philadelphia, PA",
    description:
      "• Facilitated the delivery of top-tier technical support for corporate IT systems, leveraging BetterNet to optimize issue resolution • Pioneered an innovative Python and ABAP-based integration solution to automate the synchronization of ticketing a enhancing operational efficiency and data integrity through a 40% reduction in manual data entry tasks • Crafted and deployed sophisticated Ruby scripts to automate user response systems, reducing response times by 60% and significantly improving customer satisfaction metrics by 35% through efficient handling of customer queries and issues • Managed and modernized enterprise databases using MySQL by implementing advanced indexing and query optimization techniques, ensuring data precision, enhancing core business operations, and improving data retrieval speed by 15%",
    icon: React.createElement(CgWorkAlt),
  ...
  },
  {
    ...
    description:
      "• Co-engineered an enhanced user interface as part of a five-developer team, using HTML, CSS Tailwind and Three.js resulting in a substantial increase in user experience satisfaction • Directed the integration of React.js and Next.js for website navigation, significantly enhancing operational efficiency by 12% and optimizing user interaction fluidity through improved server-side rendering and dynamic routing • Performed in-depth data analysis of user engagement, influencing a UI/UX strategic overhaul that led to a 10% uplift in site accessibility and a 50% rise in user retention • Spearheaded the implementation of a Python-driven user feedback system and managed the database using PostgreSQL, leveraging user insights to optimize the website, resulting in a 10% improvement in user satisfaction",
    icon: React.createElement(CgWorkAlt),
